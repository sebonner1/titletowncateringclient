...
function getCartItemsReceipt(){
    ...
    cart.forEach((item)=>{
            ...
            html += '<form> <label for = "Tip">Please enter your Tip</label><input type = "text" id = "tipy" value = "value"><input type ="submit" value = "Submit"></form>',
            tip += double.parse(document.getElementById("tipy").value),
